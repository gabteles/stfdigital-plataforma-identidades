 ...
 */
@Entity
@Table(name = "PERMISSAO", schema = "IDENTIDADES",
        uniqueConstraints = @UniqueConstraint(columnNames = { "SEQ_TIPO_INFORMACAO", "SEQ_SEGMENTO", "TIP_PERMISSAO" }))
public class Permissao extends ValueObjectSupport<Permissao> {

    @Id
    @Column(name = "SEQ_PERMISSAO")
    @SequenceGenerator(name = "PERMISSAOID", sequenceName = "IDENTIDADES.SEQ_PERMISSAO", allocationSize = 1)
