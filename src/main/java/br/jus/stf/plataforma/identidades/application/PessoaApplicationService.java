...
import br.jus.stf.plataforma.identidades.domain.model.corporativo.PessoaFactory;
...
public class PessoaApplicationService {
     ...
     * @return
     */
    @Command(description = "Recupera uma lista de pessoas, sejam estas novas ou existentes na base",
            value = "cadastrar-pessoas")
